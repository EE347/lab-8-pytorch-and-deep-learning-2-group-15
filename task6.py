        ...
        for loss_name, criterion in loss_functions.items():
            ...
            for epoch in range(1, 100):
                ...
                if train_loss < best_train_loss:
                    ...
                    torch.save(model.state_dict(), f'6best_model_{loss_name}.pth')

                # Save the current model
                torch.save(model.state_dict(), f'6current_model_{loss_name}.pth')
                ...
                plt.ylabel('Loss')
                plt.legend()
                plt.title(f'6Loss Curve ({loss_name})')
                plt.savefig(f'6loss_plot_{loss_name}.png')
                plt.close()
