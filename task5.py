        ...
        for loss_name, criterion in loss_functions.items():
            ...
            for epoch in range(1, 100):
                ...
                if train_loss < best_train_loss:
                    ...
                    torch.save(model.state_dict(), f'5best_model_{loss_name}.pth')

                # Save the current model
                torch.save(model.state_dict(), f'5current_model_{loss_name}.pth')
                ...
                plt.ylabel('Loss')
                plt.legend()
                plt.title(f'5Loss Curve ({loss_name})')
                plt.savefig(f'5loss_plot_{loss_name}.png')
                plt.close()
